if [ ! -f ~/.config/hypr/conf/monitor.conf ] ;then
    ...
    echo
    screenres=$(gum choose --height 15 "1024x768" "1280x720" "1280x800" "1440x900" "1280x1024" "1680x1050" "1280x1440" "1600x1200" "1920x1080" "1920x1200" "2560x1440" "2560x1600" "3840x2160")
